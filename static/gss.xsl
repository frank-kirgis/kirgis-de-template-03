...
<xsl:stylesheet version="2.0" 
  ...
  <xsl:template name="siteindexTable">
    <h3>This sitemap index file was created by <a href="http://www.caupo.net/">CaupoShop Pro</a>.</h3>          
  ...
  <xsl:template name="sitemapTable">
    <h3>This Google Sitemap file was created by <a href="http://www.caupo.net/">CaupoShop Pro</a>.</h3>          
